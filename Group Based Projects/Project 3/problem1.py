...
def count_ngrams(file_name, n): 
    ...
    for line in f: 
        ...
        #iterate through text and strip all punctuation except for hyphen and spaces
        #add to a blank string
    ...
    #create an ngram dictionary
    ngram_dict = {}
    set_unique_ngrams = set()
    
    #iterate through the text. Divide all words into tuples within dictionaries of consecutive words.
    #ngram_dict_key is how many times that ngram shows up. The dictionary key is the number of times the tuple of n-words appear.
...
#main program. 
#n sets ngram length
#most_frequent sets the number of highest frequency ngrams at the end of hte program
def main():
    filename = "alice.txt"
    n = 2
    most_frequent_k = 5
