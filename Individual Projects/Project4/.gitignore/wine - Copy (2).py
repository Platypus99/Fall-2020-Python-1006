...
def cross_validation(ww_data, rw_data, k):
    ...
    for items in range(k):
        print("ww interval size: ", interval_size_ww)
        print("rw interval size: ", interval_size_rw)
        ...
        # debugging
        ww_training_set_size1 = ww_training_set1.shape
        ww_training_set_size2 = ww_training_set2.shape
        print("ww training set1 size: ", ww_training_set_size1)   
        print("ww training set2 size: ", ww_training_set_size2)
        
        ww_full_training_data = np.vstack((ww_training_set1, ww_training_set2)) 
        
        # debugging
        # print("ww_full_training_data: ", ww_full_training_data)
        
        # ww set up testing data set
        ww_testing_data = ww_data[testing_interval_start_ww: testing_interval_end_ww, :]
        
        # debugging
        ww_testing_data_size = ww_testing_data.shape
        print("ww testing data size : ", ww_testing_data_size) 
